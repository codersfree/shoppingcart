...
namespace CodersFree\Shoppingcart;
...
use CodersFree\Shoppingcart\Exceptions\UnknownModelException;
use CodersFree\Shoppingcart\Exceptions\InvalidRowIDException;
use CodersFree\Shoppingcart\Exceptions\CartAlreadyStoredException;
...
class Cart
{
     ...
     * @param array     $options
     * @param float     $taxrate
     * @return \CodersFree\Shoppingcart\CartItem
     */
