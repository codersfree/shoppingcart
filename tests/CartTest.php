...
namespace CodersFree\Tests\Shoppingcart;

use Mockery;
use PHPUnit\Framework\Assert;
use CodersFree\Shoppingcart\Cart;
use Orchestra\Testbench\TestCase;
use Illuminate\Auth\Events\Logout;
use Illuminate\Support\Collection;
use CodersFree\Shoppingcart\CartItem;
use Illuminate\Support\Facades\Event;
use Illuminate\Session\SessionManager;
use Illuminate\Contracts\Auth\Authenticatable;
use CodersFree\Shoppingcart\ShoppingcartServiceProvider;
use CodersFree\Tests\Shoppingcart\Fixtures\ProductModel;
use CodersFree\Tests\Shoppingcart\Fixtures\BuyableProduct;
...
class CartTest extends TestCase
{
    ...
    /**
     * @test
     * @expectedException \CodersFree\Shoppingcart\Exceptions\InvalidRowIDException
     */
    ...
    /**
     * @test
     * @expectedException \CodersFree\Shoppingcart\Exceptions\UnknownModelException
     ...
     *
     * @return \CodersFree\Shoppingcart\Cart
     */
