## LaravelShoppingcart
[![Build Status](https://travis-ci.org/codersfree/LaravelShoppingcart.png?branch=master)](https://travis-ci.org/codersfree/LaravelShoppingcart)
[![Total Downloads](https://poser.pugx.org/codersfree/shoppingcart/downloads.png)](https://packagist.org/packages/codersfree/shoppingcart)
[![Latest Stable Version](https://poser.pugx.org/codersfree/shoppingcart/v/stable)](https://packagist.org/packages/codersfree/shoppingcart)
[![Latest Unstable Version](https://poser.pugx.org/codersfree/shoppingcart/v/unstable)](https://packagist.org/packages/codersfree/shoppingcart)
...
And optionally add a new line to the `aliases` array:
	...
	'Cart' => CodersFree\Shoppingcart\Facades\Cart::class,
...
The path to the `Buyable` interface is:
    ...
    CodersFree\Shoppingcart\Contracts\Buyable;
...
If you want to change these options, you'll have to publish the `config` file.
    ...
    php artisan vendor:publish --provider="CodersFree\Shoppingcart\ShoppingcartServiceProvider" --tag="config"

This will give you a `cart.php` config file in which you can make the changes.

To make your life easy, the package also includes a ready to use `migration` which you can publish by running:

    php artisan vendor:publish --provider="CodersFree\Shoppingcart\ShoppingcartServiceProvider" --tag="migrations"
